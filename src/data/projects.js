export const projects = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Engaged in both outsourced projects and the development of internal tools.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Built the platform from scratch within two weeks, enabling users to publish their books chapter-by-chapter, receive likes/comments and engage with their audience.',
      ...
      "We didn't hit the instant product-market fit, so the founder made a decision to pivot, to reduce chapters size to 140 words (for content to be more engaging). This assumption didn't work and we pivoted again, now to manga-like visual stories format.",
  ...
  },
  {
    ...
    bullets: [
      ...
      'Designed an iterative text generation approach, where users start with a single word suggestion and progressively build upon it - to phrase, sentence, paragraph, section, and ultimately full-scale articles/chapters.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Implemented a comprehensive note management system designed to accommodate the dynamic nature of legal workflows, allowing for the addition of supplementary chapters and ensuring consistent case organization.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Built an AI pipeline transforming long videos into short clips.',
      'Developed frontend and video editor interface to add captions, subtitles, trim, crop or apply various effects to the videos.',
      'Developed the backend part utilizing Hasura for the GraphQL api and ffmpg for the video editing service.',
      'Fine-tuned GPT model for clip title generation.',
      'Project was halted due to long-term collaboration concerns among the founding team.',
    ],
  },
  //{
  //  name: 'Clipcuts',
  ...
  //},
  {
    ...
    // ],
    bullets: [
      'Built media gallery equipped with AI features, such as photo restoration, image text recognition, audio transcription and translation.',
      'Pioneered "MemoryClips": A tool transforming GEDCOM files into personalized video stories. Utilized Claude LLM, Azure Text-to-Speech and Google Images Search API to produce script narratives. Utilized Remotion, AWS Lambda and S3 services for scalable video rending.',
      ...
      // 'Worked on various improvements among the product and helped to carry project to the launch.',

      'Implemented a range of other product improvements and played a key role in driving the project to the launch.',
